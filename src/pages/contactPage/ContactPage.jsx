          ...
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <div className="relative">
                ...
                <textarea
                  id="message"
                  name="message"
                  className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-red-500 focus:bg-transparent focus:ring-2 focus:ring-red-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                ></textarea>
              </div>
            </div>
            <div className="p-2 w-full">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              ...
              <span className="inline-flex">
                <a href="akashj.vasava@gmail.com" className="text-gray-500">
